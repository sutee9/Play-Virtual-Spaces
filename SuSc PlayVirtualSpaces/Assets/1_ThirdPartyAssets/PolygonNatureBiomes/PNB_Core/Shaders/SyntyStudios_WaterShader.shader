	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float2 texCoord312 = input.texcoord.xy * float2( 1,1 ) + temp_cast_1;
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord312 = input.ase_texcoord9.xy * float2( 1,1 ) + temp_cast_6;
				float simplePerlin2D320 = snoise( texCoord312*_WaveNoiseScale );
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input )
			{
				...
				float mulTime307 = _TimeParameters.x * 0.001;
				float2 temp_cast_1 = (mulTime307).xx;
				float2 texCoord312 = input.ase_texcoord.xy * float2( 1,1 ) + temp_cast_1;
				float simplePerlin2D320 = snoise( texCoord312*_WaveNoiseScale );
				float3 ase_worldPos = TransformObjectToWorld( (input.positionOS).xyz );
				float2 appendResult59 = (float2(ase_worldPos.x , ase_worldPos.z));
				float cos302 = cos( _WaveDirection );
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float mulTime307 = _TimeParameters.x * 0.001;
				float2 temp_cast_1 = (mulTime307).xx;
				float2 texCoord312 = input.texcoord0.xy * float2( 1,1 ) + temp_cast_1;
				float simplePerlin2D320 = snoise( texCoord312*_WaveNoiseScale );
				float3 ase_worldPos = TransformObjectToWorld( (input.positionOS).xyz );
				float2 appendResult59 = (float2(ase_worldPos.x , ase_worldPos.z));
				float cos302 = cos( _WaveDirection );
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float mulTime307 = _TimeParameters.x * 0.001;
				float2 temp_cast_6 = (mulTime307).xx;
				float2 texCoord312 = input.ase_texcoord5.xy * float2( 1,1 ) + temp_cast_6;
				float simplePerlin2D320 = snoise( texCoord312*_WaveNoiseScale );
				float2 appendResult59 = (float2(WorldPosition.x , WorldPosition.z));
				float cos302 = cos( _WaveDirection );
				float sin302 = sin( _WaveDirection );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float mulTime307 = _TimeParameters.x * 0.001;
				float2 temp_cast_6 = (mulTime307).xx;
				float2 texCoord312 = input.ase_texcoord3.xy * float2( 1,1 ) + temp_cast_6;
				float simplePerlin2D320 = snoise( texCoord312*_WaveNoiseScale );
				float2 appendResult59 = (float2(WorldPosition.x , WorldPosition.z));
				float cos302 = cos( _WaveDirection );
				float sin302 = sin( _WaveDirection );
...
Node;AmplifyShaderEditor.SamplerNode;39;-3298.166,682.169;Inherit;True;Property;_Foam_Texture;Foam_Texture;25;0;Create;True;0;0;0;False;0;False;-1;None;729fd1c6753e02647915f7e70c13bfd9;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;52;-3561.771,-1877.115;Inherit;True;Property;_DistortionMap;Distortion Map;16;1;[Header];Create;True;1;Refraction;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;75;-5247.173,1028.769;Float;False;Property;_FoamColor;Foam Color;20;1;[Header];Create;True;1;Foam;0;0;False;0;False;0.5215687,0.8980392,0.8470588,0;0.5199804,0.8962264,0.8460602,1;False;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;85;-996.4259,1845.485;Inherit;True;Property;_FoamMask;Foam Mask;38;0;Create;True;0;0;0;False;0;False;-1;None;77c465e84959d4b40b1d80c93f73a186;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;108;-3755.145,-321.7485;Float;False;Property;_ShallowColour;Shallow Colour;6;1;[Header];Create;True;1;Colour;0;0;False;0;False;0.9607843,0.7882353,0.5764706,0;0.9529412,0.7882354,0.5882353,0;False;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;101;-3501.157,-266.0128;Float;False;Property;_DeepColour;Deep Colour;7;0;Create;True;0;0;0;False;0;False;0.04705882,0.3098039,0.1960784,0;0.07450981,0.4313726,0.4,0;False;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;176;-3406.729,7.462919;Float;False;Property;_VeryDeepColour;Very Deep Colour;8;0;Create;True;0;0;0;False;0;False;0.05959199,0.08247829,0.191,0;0.01176471,0.172549,0.2745098,0;False;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;135;-850.222,2285.847;Inherit;True;Property;_WaveMask;Wave Mask;37;0;Create;True;0;0;0;False;0;False;-1;None;796e3706ceb704247adb957915a9edaf;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;139;-3537.521,-2607.857;Inherit;False;Property;_CausticColour;Caustic Colour;12;1;[Header];Create;True;1;Caustics;0;0;False;0;False;0.496,0.496,0.496,0;0.355,0.355,0.355,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;330;-1212.688,-72.92902;Inherit;False;Property;_FoamEmitColour;Foam Emit Colour;44;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;336;-994.0917,-394.7377;Inherit;False;Property;_DepthGlowColour;Depth Glow Colour;41;1;[Header];Create;True;1;Glow;0;0;False;0;False;0,0,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;120;-3427.848,-910.5505;Inherit;True;Property;_RipplesNormal2;Ripples Normal 2;28;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;129;-3464.382,-1189.888;Inherit;True;Property;_RipplesNormal;Ripples Normal;26;1;[Header];Create;True;1;Waves;0;0;False;0;False;-1;None;None;True;0;True;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;351;0,100;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=24CE0E986287471B6E2B51599D513493EF1F77E5