	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float2 temp_cast_0 = (( input.positionOS.xyz.x + mulTime28 )).xx;
				float lerpResult50 = lerp( tex2Dlod( _Leaves_NoiseTexture2, float4( temp_cast_0, 0, 0.0) ).r , 0.0 , ( 1.0 - input.ase_color.g ));
				...
				float lerpResult130 = lerp( ( simplePerlin3D117 * sin( ( _LeafBigNoiseScale * ( grayscale304 + _TimeParameters.x ) ) ) ) , 0.0 , ( 1.0 - input.ase_color.g ));
				...
				float lerpResult101 = lerp( ( temp_output_177_0 + _WindBaseline ) , 0.0 , ( 1.0 - input.ase_color.r ));
						 ...
						 ) : SV_Target
			{
				...
				float4 lerpResult378 = lerp( ( _GustHighlight * gustValue373 ) , float4( 0,0,0,0 ) , ( 1.0 - input.ase_color.g ));
				float4 temp_output_379_0 = ( lerpResult600 + lerpResult378 );
				float lerpResult659 = lerp( WorldNormal.y , input.ase_normal.y , _FrostingWorldObjectSwitch2);
				...
				float4 Albedo78 = ( input.ase_color.b > 0.5 ? lerpResult605 : lerpResult603 );
				...
				float2 uv_Emissive2Mask = input.ase_texcoord9.xy * _Emissive2Mask_ST.xy + _Emissive2Mask_ST.zw;
				...
				float2 texCoord435 = input.ase_texcoord9.xy * temp_cast_5 + temp_cast_6;
				...
				float4 Emissive420 = ( ( input.ase_color.b > 0.5 ? ( lerpResult417 + lerpResult457 ) : lerpResult569 ) * _EmissiveAmount * (0.5 + (clampResult444 - 0.0) * (1.0 - 0.5) / (1.0 - 0.0)) );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float lerpResult659 = lerp( ase_worldNormal.y , input.ase_normal.y , _FrostingWorldObjectSwitch2);
				float4 lerpResult461 = lerp( temp_output_379_0 , _FrostingColour , saturate( ( pow( lerpResult659 , _FrostingHeight ) * _FrostingFalloff ) ));
				float4 lerpResult605 = lerp( temp_output_379_0 , lerpResult461 , _FrostingSwitch);
				float4 lerpResult570 = lerp( _TrunkNoiseColour , _TrunkBaseColour , grayscale66);
				float4 blendOpSrc575 = temp_output_551_0;
				...
				float4 lerpResult417 = lerp( _EmissiveColour , float4( 0,0,0,0 ) , ( 1.0 - tex2D( _EmissiveMask, uv_EmissiveMask ).r ));
				float2 uv_Emissive2Mask = input.ase_texcoord4.xy * _Emissive2Mask_ST.xy + _Emissive2Mask_ST.zw;
				float4 lerpResult457 = lerp( _Emissive2Colour , float4( 0,0,0,0 ) , ( 1.0 - tex2D( _Emissive2Mask, uv_Emissive2Mask ).r ));
				...
				float mulTime436 = _TimeParameters.x * _PulseSpeed;
				float2 temp_cast_6 = (mulTime436).xx;
				float2 texCoord435 = input.ase_texcoord4.xy * temp_cast_5 + temp_cast_6;
				float4 appendResult441 = (float4(WorldPosition.x , 0.0 , WorldPosition.z , 0.0));
				float mulTime430 = _TimeParameters.x * 4.0;
				float grayscale432 = Luminance(sin( ( ( appendResult441 * 0.5 ) + mulTime430 ) ).xyz);
				float clampResult444 = clamp( max( tex2D( _EmissivePulseMap, texCoord435 ).r , grayscale432 ) , 0.0 , 1.0 );
...
Node;AmplifyShaderEditor.ColorNode;63;-1009.043,-1544.865;Inherit;False;Property;_LeafBaseColour;LeafBaseColour;13;1;[Header];Create;True;1;Colour Tinting;0;0;False;0;False;0.07843138,0.02015968,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;507;-441.8385,-1473.494;Inherit;False;Property;_LeafNoiseLargeColour;LeafNoiseLargeColour;15;0;Create;True;0;0;0;False;0;False;0.07843138,0.02015968,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;65;-1005.823,-1722.327;Inherit;False;Property;_LeafNoiseColour;LeafNoiseColour;14;0;Create;True;0;0;0;False;0;False;0.07843138,0.02015968,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;70;-1055.394,-2158.999;Inherit;True;Property;_LeafTex;LeafTex;1;1;[Header];Create;True;1;Leaves;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;550;-1049.25,-1955.424;Inherit;True;Property;_TunkTex;TunkTex;7;1;[Header];Create;True;1;Trunk;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;377;-350.6857,-1259.393;Inherit;False;Property;_GustHighlight;GustHighlight;41;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.135055,0.1509434,0.1288714,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;46;-2805.407,-650.3812;Inherit;True;Property;_Leaves_NoiseTexture2;LeafJitterMap;46;0;Create;False;0;0;0;False;0;False;-1;e0595e1df515fa64fa99e3017d4ace24;e0595e1df515fa64fa99e3017d4ace24;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;454;-3717.798,2920.447;Inherit;True;Property;_Emissive2Mask;Emissive2Mask;25;0;Create;True;1;Emissive;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;200;-3719.584,2630.946;Inherit;True;Property;_EmissiveMask;EmissiveMask;23;0;Create;True;1;Emissive;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;566;-3637.677,3184.796;Inherit;True;Property;_TrunkEmissiveMask;TrunkEmissiveMask;28;0;Create;True;1;Emissive;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;418;-3415.918,2537.3;Inherit;False;Property;_EmissiveColour;EmissiveColour;24;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;218;-213.7214,-718.5309;Inherit;False;Property;_TrunkBaseColour;TrunkBaseColour;17;0;Create;True;0;0;0;False;0;False;0.07843138,0.02015968,0,0;0.07843132,0.02015968,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;456;-3416.132,2826.801;Inherit;False;Property;_Emissive2Colour;Emissive2Colour;26;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;217;-208.499,-900.8921;Inherit;False;Property;_TrunkNoiseColour;TrunkNoiseColour;18;0;Create;True;0;0;0;False;0;False;0.07843138,0.02015968,0,0;0.07843132,0.02015968,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;433;-2998.298,1902.813;Inherit;True;Property;_EmissivePulseMap;EmissivePulseMap;29;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;481;473.7535,-2131.432;Inherit;False;Property;_FrostingColour;FrostingColour;47;1;[Header];Create;True;1;Frosting;0;0;False;0;False;1,1,1,0;1,1,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;568;-3336.011,3091.15;Inherit;False;Property;_TrunkEmissiveColour;TrunkEmissiveColour;27;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;562;-917.9802,-78.95667;Inherit;True;Property;_TrunkNormalMap;TrunkNormalMap;8;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;0.5;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;582;-1198.813,939.0795;Inherit;True;Property;_TrunkAmbientOcclusion;TrunkAmbientOcclusion;12;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;286;-1198.322,738.4786;Inherit;True;Property;_LeafAmbientOcclusion;LeafAmbientOcclusion;6;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;660;41.30931,309.989;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=5EFBC7B6BFA4CDB102CF09E313BEF0ABB07EAD0E